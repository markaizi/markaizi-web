    ...
    <div className="min-h-screen" style={{ background: "var(--bg)" }}>
      <header className="sticky top-0 z-50 px-6 py-4 flex items-center justify-between"
        ...
        <div className="flex items-center gap-3">
          <a href="/musteri/calisan" className="font-black text-[18px] gradient-text">markaizi</a>
          <span className="text-[#555]">/</span>
          <a href="/musteri/calisan" className="text-[14px] text-[#8a8a9a] hover:text-white transition-colors">Çalışan Paneli</a>
          <span className="text-[#555]">/</span>
          <span className="text-[14px] font-semibold text-white">İş Akışı</span>
        </div>
        <a href="/musteri/calisan" className="text-[13px] text-[#8a8a9a] hover:text-white transition-colors">← Panele Dön</a>
      </header>
