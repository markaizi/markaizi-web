    ...
    <div className="min-h-screen" style={{ background: "var(--bg)" }}>
      ...
      <main className="max-w-[520px] mx-auto px-6 py-10 space-y-6">
        ...
        <form onSubmit={handleName} className="rounded-2xl p-5 space-y-4"
          ...
          <div>
            <label className="block text-[11px] font-semibold text-[#8a8a9a] uppercase tracking-wide mb-1.5">Yeni Ad Soyad</label>
          ...
          <div>
            <label className="block text-[11px] font-semibold text-[#8a8a9a] uppercase tracking-wide mb-1.5">Yeni E-posta</label>
            <input type="email" value={nameForm.email} onChange={(e) => setNameForm((f) => ({ ...f, email: e.target.value }))}
        ...
        <form onSubmit={handlePw} className="rounded-2xl p-5 space-y-4"
          ...
          {[
            ...
            <div key={key}>
              ...
              <input required type="password" value={pwForm[key as keyof typeof pwForm]}
