    ...
    <section id="iletisim" className="py-24">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="text-center max-w-[680px] mx-auto mb-16 reveal">
          ...
          <p className="text-[#8a8a9a] text-[17px]">Size özel ücretsiz danışmanlık için formu doldurun, 24 saat içinde size ulaşalım.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-14 items-start">
          ...
          >
            ...
            <div className="mb-5">
              <Field label="Telefon" id="phone" type="tel" placeholder="+90 555 000 00 00" />
            </div>
            <div className="mb-5">
              ...
              <select
                ...
                style={{ background:"var(--bg)", border:"1.5px solid var(--border)", appearance:"none", WebkitAppearance:"none", cursor:"pointer",
          ...
          <div className="reveal flex flex-col gap-0">
            {[
              {
                label: "Telefon", value: "+90 (532) 000 00 00",
              ...
              {
                label: "E-posta", value: "info@markaizi.com",
              ...
              <div key={item.label} className="flex items-start gap-4 py-6" style={{ borderBottom:"1px solid var(--border)" }}>
                ...
                <div>
                  ...
                  <span className="text-[15px] text-[#8a8a9a]">{item.value}</span>
                </div>
              </div>
            ))}
...
function Field({ label, id, type, placeholder, required }: { label: string; id: string; type: string; placeholder: string; required?: boolean }) {
  return (
    <div>
      <label htmlFor={id} className="block text-[13px] font-semibold text-[#8a8a9a] uppercase tracking-wide mb-2">{label}</label>
      <input
        id={id}
        name={id}
        type={type}
